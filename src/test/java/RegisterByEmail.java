...
public class RegisterByEmail {
    @Test
    public void verify_register_by_email() {
        String register_url = ConfigManager.get("register_url");
        String register_body = ConfigManager.get("register_email_body");
        String email = "test"+CommonFunction.RandomNumber()+"@gmail.com";
        register_body = register_body.replace("email",email);
